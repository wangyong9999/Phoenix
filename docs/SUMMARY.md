...
# OrioleDB Serverless Integration

- [OrioleDB Serverless Architecture](./ORIOLEDB_SERVERLESS.md) — Log-is-Data stateless compute design
- [PG Patches Inventory](./PG_PATCHES_INVENTORY.md) — Neon + OrioleDB PostgreSQL modifications
