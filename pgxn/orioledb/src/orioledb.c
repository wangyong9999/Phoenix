...
_PG_init(void)
{
	 ...
	 * Only RMGR registration is needed for orioledb_page_redo() to replay
	 * page-level WAL records. The wal-redo process has no shmem context
	 * and runs in a seccomp sandbox.
	 */
