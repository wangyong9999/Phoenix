...
{
	/*
	 * Neon + OrioleDB: OrioleDB sends shared invalidation messages
	 * during CommitTransactionCommand, when IsTransactionState() may
	 * already be false. These invalidations evict stale cache entries
	 * and are safe outside a transaction context.
	 */
